...
if($deptug){
$query="SELECT regno,name,gender,mail,mobile,land,dob,xth,xthyop,inter,interyop,sem1,sem2,sem3,sem4,sem5,sem6,sem7,sem8,agg,blogs,hob,focc,address,height,weight,sight,fname,mname,dept,comone,comtwo,numcom FROM preug where";
$que=" (";
...
if($deptpg){
$query="SELECT regno,name,gender,mail,mobile,land,dob,xth,xthyop,inter,interyop,degree,degreeyop,pgcet,sem1,sem2,sem3,sem4,agg,blogs,hob,focc,address,height,weight,sight,fname,mname,dept,comone,comtwo,numcom FROM prepg where";
$que=" (";
...
if($deptmba){
$query="SELECT regno,name,gender,mail,mobile,land,dob,xth,xthyop,inter,interyop,degree,degreeyop,icet,sem1,sem2,sem3,sem4,agg,blogs,hob,focc,address,height,weight,sight,fname,mname,dept,comone,comtwo,numcom FROM premba where";
$que=" (";
...
if($deptmca){
$query="SELECT regno,name,gender,mail,mobile,land,dob,xth,xthyop,inter,interyop,degree,degreeyop,icet,sem1,sem2,sem3,sem4,agg,blogs,hob,focc,address,height,weight,sight,fname,mname,dept,comone,comtwo,numcom FROM premca where";
$que=" (";
...
if($deptug){
$query="SELECT regno,name,gender,dept,agg,mobile,land,mail FROM preug where";
$que=" (";
for($i=0; $i < count($deptug);$i++)
{
$que=$que."dept = "."'".$deptug[$i]."'";
...
if($deptpg){
$query="SELECT regno,name,gender,dept,agg,mobile,land,mail FROM prepg where";
$que=" (";
for($i=0; $i < count($deptpg);$i++)
{
$que=$que."dept = "."'".$deptpg[$i]."'";
...
if($deptmba){
$query="SELECT regno,name,gender,dept,agg,mobile,land,mail FROM premba where";
$que=" (";
for($i=0; $i < count($deptmba);$i++)
{
$que=$que."dept = "."'".$deptmba[$i]."'";
...
if($deptmca){
$query="SELECT regno,name,gender,dept,agg,mobile,land,mail FROM premca where";
$que=" (";
for($i=0; $i < count($deptmca);$i++)
{
$que=$que."dept = "."'".$deptmca[$i]."'";
