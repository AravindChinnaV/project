...
$result=mysql_query("SELECT name FROM ".$tablename." WHERE regno='$myusername' and password='$mypassword'");
...
$_SESSION['login_department']=$mydepartment;
...
var ck_department = /^[A-Za-z0-9 .]{2,20}$/;
...
{
$(this).next().hide();
$("li").next("li.department").slideDown({duration: 'slow',easing: 'easeOutElastic'});
}
});
...
if (!ck_department.test(department)) 
{
 $(this).next().show().html("Ex: IT");
}
else
{
$(this).next().hide();
...
<option value="ug">CIVIL</option>
<option value="pg">CSE</option>
<option value="mba">ECE</option>
<option value="mca">EIE</option>
<option value="mca">EEE</option>
<option value="mca">IT</option>
<option value="mca">MECHANICAL</option>
</select>
<span class="error"></span></div>
</li>
<li class="username">
