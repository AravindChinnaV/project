...
<?php
$result = mysql_query("SELECT submit,degree,degreeyop,pgcet,sem1,sem2,sem3,sem4,agg,blogs,hob FROM prepg WHERE regno = '$login_session'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE prepg SET degree='$degree',degreeyop='$degreeyop',pgcet='$pgcet',sem1='$sem1',sem2='$sem2',sem3='$sem3',sem4='$sem4',agg='$agg',blogs='$blogs',hob='$hob' WHERE regno='$login_session'";
