...
<?php
$result = mysql_query("SELECT submit,degree,degreeyop,icet,sem1,sem2,sem3,sem4,agg,blogs,hob FROM premba WHERE regno = '$login_session'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE premba SET degree='$degree',degreeyop='$degreeyop',icet='$icet',sem1='$sem1',sem2='$sem2',sem3='$sem3',sem4='$sem4',agg='$agg',blogs='$blogs',hob='$hob' WHERE regno='$login_session'";
