...
$result = mysql_query("SELECT submit,comone,comtwo,numcom FROM finalpg WHERE regno = '$regno'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE finalpg SET comone='$comone',comtwo='$comtwo',numcom='$numcom' WHERE regno='$regno'";
