...
if($course=="ug")
{
$result = mysql_query("INSERT into preug (regno,password,dept) VALUES ('$regno','$pwd','$dept')");
}
else if($course=="pg")
{
$result = mysql_query("INSERT into prepg (regno,password,dept) VALUES ('$regno','$pwd','$dept')");
}
else if($course=="mba")
{
$result = mysql_query("INSERT into premba (regno,password,dept) VALUES ('$regno','$pwd','$dept')");
}
else if($course=="mca")
{
$result = mysql_query("INSERT into premca (regno,password,dept) VALUES ('$regno','$pwd','$dept')");
}
if (!$result) {
