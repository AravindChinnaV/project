...
<small>Welcome&nbsp;&nbsp;<font color="#3BB9FF"><?php echo $login_session; ?></font></small>
				...
				<ul> 
					<li><a class="transition" href="./index.php"  style="text-decoration: none; border-bottom: 1px solid #42C0FB" title="Home">Home</a></li> 
					...
					<li><a class="current" href="./chpwd.php" style="text-decoration: none; border-bottom: 5px solid #42C0FB">Change Password</a></li> 
...
$result = mysql_query("SELECT regno FROM `finalmca` WHERE regno='$us' and password='$old'");
$row = mysql_fetch_row($result);
$count=mysql_num_rows($result);

if($count==1 && $new==$cnew)
{
$sql="UPDATE finalmca SET password='$new' WHERE regno='$login_session'";
