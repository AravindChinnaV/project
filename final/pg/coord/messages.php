...
<small>Welcome&nbsp;&nbsp;<font color="#3BB9FF"><?php echo $login_session; ?></font>&nbsp;Coordinator</small>
					...
					<li><a class="current" href="./messages.php" style="text-decoration: none; border-bottom: 5px solid #42C0FB">Messages</a></li>
					<li><a class="transition" href="./adds.php" style="text-decoration: none; border-bottom: 1px solid #42C0FB">Add Student</a></li> 
					<li><a class="tranisition" href="./search.php" style="text-decoration: none; border-bottom: 1px solid #42C0FB">Modify Profile</a></li>
...
<iframe src="leftmenu.php" style="border: 1px #42C0FB solid;" height="450" width="150"></iframe>

<iframe src="list_pm.php" name="viewframe" style="border: 1px #42C0FB solid;" height="450" width="670"></iframe>
</div>
