...
<?php
$result = mysql_query("SELECT submit,focc,address,pab,height,weight,sight,fname,mname FROM prepg WHERE regno = '$login_session'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE prepg SET focc='$focc',address='$address',pab='$pab',height='$height',weight='$weight',sight='$sight',fname='$fname',mname='$mname' WHERE regno='$login_session'";
...
{
$sql="UPDATE prepg SET submit='yes',focc='$focc',address='$address',pab='$pab',height='$height',weight='$weight',sight='$sight',fname='$fname',mname='$mname' WHERE regno='$login_session'";
$result=mysql_query($sql);
if(!$result)
{
echo "Something gone wrong try agian";
