...
{
$first=$_POST['first']; 
$twoone=addslashes($_POST['twoone']);
$twotwo=addslashes($_POST['twotwo']); 
$threeone=addslashes($_POST['threeone']);
$threetwo=addslashes($_POST['threetwo']); 
$fourone=addslashes($_POST['fourone']);
...
if($_POST['store']=='Save')
{
$sql="UPDATE ".$table." SET first='$first',twoone='$twoone',twotwo='$twotwo',threeone='$threeone',threetwo='$threetwo',fourone='$fourone',agg='$agg',blogs='$blogs',hob='$hob' WHERE regno='$regno'";
...
{
$sql="UPDATE itdb SET first='$first',twoone='$twoone',twotwo='$twotwo',threeone='$threeone',threetwo='$threetwo',fourone='$fourone',agg='$agg',blogs='$blogs',hob='$hob',submit='yes' WHERE regno='$regno'";
$result=mysql_query($sql);
if(!$result)
{
echo "Something gone wrong try agian";
