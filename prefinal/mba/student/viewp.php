...
<?php
$result = mysql_query("SELECT name,regno,gender,mail,mobile,dob,xth,xthyop,inter,interyop,degree,degreeyop,icet,sem1,sem2,sem3,sem4,agg,blogs,hob,focc,address,pab,height,weight,sight,fname,mname,dept FROM premba WHERE regno = '$login_session'");
if (!$result) {
