...
<?php
$result = mysql_query("SELECT submit,focc,address,pab,height,weight,sight,fname,mname FROM premca WHERE regno = '$login_session'");
if (!$result) {
...
<div class="span3">
<label>Preference after MCA:</label></br><input type="text" name="pab" id="pab" value="<?php echo "$pab";?>" <?php echo "$pb";?>/></br>
...
if($_POST['store']=='Save')
{
$sql="UPDATE premca SET focc='$focc',address='$address',pab='$pab',height='$height',weight='$weight',sight='$sight',fname='$fname',mname='$mname' WHERE regno='$login_session'";
...
{
$sql="UPDATE premca SET submit='yes',focc='$focc',address='$address',pab='$pab',height='$height',weight='$weight',sight='$sight',fname='$fname',mname='$mname' WHERE regno='$login_session'";
$result=mysql_query($sql);
if(!$result)
{
echo "Something gone wrong try agian";
