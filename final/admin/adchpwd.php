...
<small>Welcome T&P <font color="#3BB9FF"><?php echo $login_session; ?></font></small>
				...
				<ul> 
					...
					<li><a class="current" href="./adchpwd.php" style="text-decoration: none; border-bottom: 5px solid #42C0FB">Change Password</a></li>
...
$result = mysql_query("SELECT id FROM `users` WHERE regno='$us' and password='$old'");
$row = mysql_fetch_row($result);
$count=mysql_num_rows($result);

if($count==1 && $new==$cnew)
{
$sql="UPDATE users SET password='$new' WHERE regno='$login_session'";
