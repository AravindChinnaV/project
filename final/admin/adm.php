...
<small>Modify&nbsp;<font color="#3BB9FF"><?php echo $regno; ?></font></small>
		...
		<ul id="nav">
		<li>
				<a href="brega.php" class="icon1">
					<span><font color="#000">Basic Details</font></span>
				</a>
			</li>
			<li>
				<a href="arega.php" class="icon2">
					<span><font color="#000">Academic Details</font></span>
				</a>
			</li>
			<li>
				<a href="prega.php" class="icon3">
					<span><font color="#000">Personal Details</font></span>
				</a>
			</li>
			<li>
				<a href="screga.php" class="icon4">
					<span><font color="#000">Selected Companies</font></span>
				</a>
			</li>
