...
$result = mysql_query("SELECT submit,name,regno,gender,mail,mobile,dob,xth,xthyop,inter,interyop,dept,rank,land FROM finalmba WHERE regno = '$regno'");
if (!$result) {
...
<label>Inter/Diploma Year of Pass:</label></br><input type="text" name="interyop" id="interyop" value="<?php echo "$interyop";?>" <?php echo "$inty";?>/></br><input style="margin:50px 0 0 35px;" type="submit" name="store" value="Save" id='submit'/>
...
if($_POST['store']=='Save')
{
$sql="UPDATE finalmba SET name='$name',dept='$dept',gender='$gender',rank='$rank',mail='$mail',mobile='$mobile',land='$land',dob='$dob',xth='$xth',xthyop='$xthyop',inter='$inter',interyop='$interyop' WHERE regno='$regno'";
...
{
$sql="UPDATE prepg SET name='$name',dept='$dept',gender='$gender',rank='$rank',mail='$mail',mobile='$mobile',land='$land',dob='$dob',xth='$xth',xthyop='$xthyop',inter='$inter',interyop='$interyop' WHERE regno='$regno'";
$result=mysql_query($sql);
if(!$result)
{
