...
<?php
$result = mysql_query("SELECT name,regno,gender,mail,mobile,dob,xth,xthyop,inter,interyop,sem1,sem2,sem3,sem4,sem5,sem6,sem7,sem8,agg,blogs,hob,focc,address,pab,height,weight,sight,fname,mname,dept FROM preug WHERE regno = '$login_session'");
if (!$result) {
