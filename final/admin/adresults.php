...
$deptug =(!empty($_POST['deptug']) ? $_POST['deptug'] : false);
$deptpg =(!empty($_POST['deptpg']) ? $_POST['deptpg'] : false);
$deptmba =(!empty($_POST['deptmba']) ? $_POST['deptmba'] : false);
$deptmca =(!empty($_POST['deptmca']) ? $_POST['deptmca'] : false);

if($deptug){
$query="SELECT regno,name,gender,mail,mobile,land,dob,xth,xthyop,inter,interyop,sem1,sem2,sem3,sem4,sem5,sem6,sem7,sem8,agg,blogs,hob,focc,address,height,weight,sight,fname,mname,dept,comone,comtwo,numcom FROM finalug where";
$que=" (";
for($i=0; $i < count($deptug);$i++)
{
$que=$que."dept = "."'".$deptug[$i]."'";
if($i < count($deptug) - 1)
{
$que=$que." OR ";
}
...
if($deptpg){
$query="SELECT regno,name,gender,mail,mobile,land,dob,xth,xthyop,inter,interyop,degree,degreeyop,pgcet,sem1,sem2,sem3,sem4,agg,blogs,hob,focc,address,height,weight,sight,fname,mname,dept,comone,comtwo,numcom FROM finalpg where";
$que=" (";
for($i=0; $i < count($deptpg);$i++)
{
$que=$que."dept = "."'".$deptpg[$i]."'";
if($i < count($deptpg) - 1)
{
$que=$que." OR ";
}
...
if($deptmba){
$query="SELECT regno,name,gender,mail,mobile,land,dob,xth,xthyop,inter,interyop,degree,degreeyop,icet,sem1,sem2,sem3,sem4,agg,blogs,hob,focc,address,height,weight,sight,fname,mname,dept,comone,comtwo,numcom FROM finalmba where";
$que=" (";
for($i=0; $i < count($deptmba);$i++)
{
$que=$que."dept = "."'".$deptmba[$i]."'";
if($i < count($deptmba) - 1)
{
$que=$que." OR ";
}
}
...
if($deptmca){
$query="SELECT regno,name,gender,mail,mobile,land,dob,xth,xthyop,inter,interyop,degree,degreeyop,icet,sem1,sem2,sem3,sem4,agg,blogs,hob,focc,address,height,weight,sight,fname,mname,dept,comone,comtwo,numcom FROM finalmca where";
$que=" (";
for($i=0; $i < count($deptmca);$i++)
{
$que=$que."dept = "."'".$deptmca[$i]."'";
if($i < count($deptmca) - 1)
{
$que=$que." OR ";
}
}
...
if($deptug){
$query="SELECT regno,name,gender,dept,agg,mobile,land,mail FROM finalug where";
$que=" (";
for($i=0; $i < count($deptug);$i++)
{
$que=$que."dept = "."'".$deptug[$i]."'";
...
if($deptpg){
$query="SELECT regno,name,gender,dept,agg,mobile,land,mail FROM finalpg where";
$que=" (";
for($i=0; $i < count($deptpg);$i++)
{
$que=$que."dept = "."'".$deptpg[$i]."'";
...
if($deptmba){
$query="SELECT regno,name,gender,dept,agg,mobile,land,mail FROM finalmba where";
$que=" (";
for($i=0; $i < count($deptmba);$i++)
{
$que=$que."dept = "."'".$deptmba[$i]."'";
...
if($deptmca){
$query="SELECT regno,name,gender,dept,agg,mobile,land,mail FROM finalmca where";
$que=" (";
for($i=0; $i < count($deptmca);$i++)
{
$que=$que."dept = "."'".$deptmca[$i]."'";
...
<td><small><?php echo $row[7];?></small></td>
</tr>
<?php
$i++;
}
...
<a style="margin:auto 0 0 25px;" href="adexport.php" id='link'>Back</a>
<?php
}
?>
