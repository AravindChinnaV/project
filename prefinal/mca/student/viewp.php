...
<?php
$result = mysql_query("SELECT name,regno,gender,mail,mobile,dob,xth,xthyop,inter,interyop,degree,degreeyop,icet,sem1,sem2,sem3,sem4,sem5,sem6,agg,blogs,hob,focc,address,pab,height,weight,sight,fname,mname,dept FROM premca WHERE regno = '$login_session'");
if (!$result) {
...
<tr>
<td><font color="#808080">% in Degree</font></td>
<td><b><?php echo $row[10];?></b></td>
</tr>
<tr class="odd">
<td><font color="#808080">Degree Year of Pass</font></td>
<td><b><?php echo $row[11];?></b></td>
</tr>
<tr>
<td><font color="#808080">ICET Rank</font></td>
...
<tr>
<td><font color="#808080">Preference after MCA</font></td>
