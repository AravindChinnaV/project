...
$result = mysql_query("SELECT submit,name,regno,gender,mail,mobile,dob,xth,xthyop,inter,interyop,dept,rank,land FROM finalpg WHERE regno = '$regno'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE finalpg SET name='$name',dept='$dept',gender='$gender',rank='$rank',mail='$mail',mobile='$mobile',land='$land',dob='$dob',xth='$xth',xthyop='$xthyop',inter='$inter',interyop='$interyop' WHERE regno='$regno'";
