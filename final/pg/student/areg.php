...
<?php
$result = mysql_query("SELECT submit,degree,degreeyop,pgcet,sem1,sem2,sem3,sem4,agg,blogs,hob FROM finalpg WHERE regno = '$login_session'");
if (!$result) {
...
<label>PGCET Rank:</label></br><input type="text" name="pgcet" id="pgcet" value="<?php echo "$pgcet";?>" <?php echo "$pgc";?>/></br>
...
if($_POST['store']=='Save')
{
$sql="UPDATE finalpg SET degree='$degree',degreeyop='$degreeyop',pgcet='$pgcet',sem1='$sem1',sem2='$sem2',sem3='$sem3',sem4='$sem4',agg='$agg',blogs='$blogs',hob='$hob' WHERE regno='$login_session'";
