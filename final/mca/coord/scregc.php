...
$result = mysql_query("SELECT submit,comone,comtwo,numcom FROM finalmca WHERE regno = '$regno'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE finalmca SET comone='$comone',comtwo='$comtwo',numcom='$numcom' WHERE regno='$regno'";
