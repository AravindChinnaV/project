...
<?php
$result = mysql_query("SELECT submit,sem1,sem2,sem3,sem4,sem5,sem6,sem7,sem8,agg,blogs,hob FROM preug WHERE regno = '$login_session'");
if (!$result) {
...
<label>Aggregate in BTech:</label></br><input type="text" name="agg" id="agg" value="<?php echo "$agg";?>" <?php echo "$ag";?>/></br>
...
if($_POST['store']=='Save')
{
$sql="UPDATE preug SET sem1='$sem1',sem2='$sem2',sem3='$sem3',sem4='$sem4',sem5='$sem5',sem6='$sem6',sem7='$sem7',sem8='$sem8',agg='$agg',blogs='$blogs',hob='$hob' WHERE regno='$login_session'";
