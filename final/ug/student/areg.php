...
<?php
$result = mysql_query("SELECT submit,sem1,sem2,sem3,sem4,sem5,sem6,sem7,sem8,agg,blogs,hob FROM finalug WHERE regno = '$login_session'");
if (!$result) {
...
<label>% in Semester-5:</label></br><input type="text" name="sem5" id="sem5" value="<?php echo "$sem5";?>" <?php echo "$s5";?>/></br>
</div>
<div class="span3">
<label>% in Semester-6:</label></br><input type="text" name="sem6" id="sem6" value="<?php echo "$sem6";?>" <?php echo "$s6";?>/></br>
<label>% in Semester-7:</label></br><input type="text" name="sem7" id="sem7" value="<?php echo "$sem7";?>" <?php echo "$s7";?>/></br>
<label>% in Semester-8:</label></br><input type="text" name="sem8" id="sem8" value="<?php echo "$sem8";?>" <?php echo "$s8";?>/></br>
<label>Aggregate in BTech:</label></br><input type="text" name="degree" id="degree" value="<?php echo "$degree";?>" <?php echo "$ag";?>/></br>
...
if($_POST['store']=='Save' )
{
$sql="UPDATE finalug SET sem1='$sem1',sem2='$sem2',sem3='$sem3',sem4='$sem4',sem5='$sem5',sem6='$sem6',sem7='$sem7',sem8='$sem8',degree='$degree',blogs='$blogs',hob='$hob' WHERE regno='$login_session'";
