...
$result = mysql_query("SELECT submit,comone,comtwo,numcom FROM premca WHERE regno = '$regno'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE premca SET comone='$comone',comtwo='$comtwo',numcom='$numcom' WHERE regno='$regno'";
