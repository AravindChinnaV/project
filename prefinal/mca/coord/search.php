...
$result = mysql_query("SELECT dept FROM premca WHERE regno = '$regno'");
if (!$result) {
...
$dept=$row[0];
if($dept==$login_session)
{
session_start();

$_SESSION['reg_no']=$regno;
header("location: coordm.php");
}
else
{
echo "<div id=error>Number Not in Your Department</div>";
}
}
?>
...
<div class="row">
<div class="span4">
<small><font style="margin:0 0 0 -30px;" color="#999" size="4">Enter Reg No:</font></small></br></br>
