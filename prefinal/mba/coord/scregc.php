...
$result = mysql_query("SELECT submit,comone,comtwo,numcom FROM premba WHERE regno = '$regno'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE premba SET comone='$comone',comtwo='$comtwo',numcom='$numcom' WHERE regno='$regno'";
