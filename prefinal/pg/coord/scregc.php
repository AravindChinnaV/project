...
$result = mysql_query("SELECT submit,comone,comtwo,numcom FROM prepg WHERE regno = '$regno'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE prepg SET comone='$comone',comtwo='$comtwo',numcom='$numcom' WHERE regno='$regno'";
