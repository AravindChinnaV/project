...
$query="SELECT regno,name,gender,mail,mobile,land,dob,xth,xthyop,inter,interyop,sem1,sem2,sem3,sem4,sem5,sem6,sem7,sem8,agg,blogs,hob,focc,address,height,weight,sight,fname,mname,dept,comone,comtwo,numcom FROM premba WHERE dept='$login_session'";
if($xth){
$query.=" AND xth >= '$xth'";
}
if($inter){
...
$placed= (!empty($_POST['placed']) ? mysql_real_escape_string($_POST['placed']) : false);
$comp= (!empty($_POST['comp']) ? mysql_real_escape_string($_POST['comp']) : false);  
$query="SELECT regno,name,gender,agg,mobile,land,mail FROM premba WHERE dept='$login_session'";
if($xth){
$query.=" AND xth >= '$xth'";
}
if($inter){
