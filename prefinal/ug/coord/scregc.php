...
$result = mysql_query("SELECT submit,comone,comtwo,numcom FROM preug WHERE regno = '$regno'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE preug SET comone='$comone',comtwo='$comtwo',numcom='$numcom' WHERE regno='$regno'";
...
{
$sql="UPDATE preug SET focc='$focc',address='$address',pab='$pab',height='$height',weight='$weight',sight='$sight',religion='$religion',category='$category',subcat='$subcat',fname='$fname',mname='$mname',submit='yes' WHERE regno='$regno'";
$result=mysql_query($sql);
if(!$result)
{
