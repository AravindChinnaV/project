...
$result = mysql_query("SELECT submit,focc,address,pab,height,weight,sight,fname,mname FROM premba WHERE regno = '$regno'");
if (!$result) {
...
if($_POST['store']=='Save')
{
$sql="UPDATE premba SET focc='$focc',address='$address',pab='$pab',height='$height',weight='$weight',sight='$sight',fname='$fname',mname='$mname' WHERE regno='$regno'";
